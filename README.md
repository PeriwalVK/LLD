...
# (2) Add this to top of every lld project's main file (ex: chess/main.py, tictactoe/main.py) ==> it makes out project root folder added to sys path sop that import error is resolved
import sys
import os
